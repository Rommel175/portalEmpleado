...
export default function DatosContainer({ user, estado, localizacion, setLocalizacion, horaInicio }: { user: User, estado: string, localizacion: string, setLocalizacion: React.Dispatch<React.SetStateAction<string>>, horaInicio: string }) {
    const svg = (
