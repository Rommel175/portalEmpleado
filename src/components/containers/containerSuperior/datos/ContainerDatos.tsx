...
export default function DatosContainer({ user, estado, localizacion, setLocalizacion }: { user: User, estado: string, localizacion: string, setLocalizacion: React.Dispatch<React.SetStateAction<string>> }) {
    const svg = (
