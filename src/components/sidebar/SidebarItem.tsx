...

      {
        ...
        <Link href={'/dashboard/recursos/gestion'} className={`${(pathname == '/dashboard/recursos/gestion' || pathname == '/dashboard/recursos/informes' || pathname.startsWith('/dashboard/recursos/informes/') || pathname == '/dashboard/recursos/incidencias' || pathname == '/dashboard/recursos/comentarios') ? styles.active : ""}`}>
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M9.84905 17.2086V8.51848M15.0631 17.2086V3.30444M4.63501 17.2086V13.7325" stroke={(pathname == '/dashboard/recursos/gestion' || pathname == '/dashboard/recursos/informes' || pathname.startsWith('/dashboard/recursos/informes/') || pathname == '/dashboard/recursos/incidencias' || pathname == '/dashboard/recursos/comentarios') ? 'white' : '#0B3C70'} strokeWidth="2.16092" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          Recursos Humanos
        </Link>
      }
