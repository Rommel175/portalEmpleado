...
export default function ButtonModificar() {
                    ...
                    <div className={styles.overlay}>
                        <div className={styles.modalContainer}>
                            <header className={styles.title}>
                                ...
                                <div>
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12.0683 4.22716V2.86353M5.93195 4.22716V2.86353M3.03422 6.27262H14.966M2.86377 7.66625C2.86377 6.22421 2.86377 5.50284 3.16104 4.95193C3.42985 4.46055 3.84695 4.0666 4.35286 3.82625C4.9365 3.54534 5.70013 3.54534 7.22741 3.54534H10.7729C12.3001 3.54534 13.0638 3.54534 13.6474 3.82625C14.1608 4.07307 14.5774 4.46716 14.8392 4.95125C15.1365 5.50353 15.1365 6.22489 15.1365 7.66693V11.016C15.1365 12.4581 15.1365 13.1794 14.8392 13.7303C14.5704 14.2217 14.1533 14.6157 13.6474 14.856C13.0638 15.1363 12.3001 15.1363 10.7729 15.1363H7.22741C5.70013 15.1363 4.9365 15.1363 4.35286 14.8553C3.84705 14.6152 3.42996 14.2215 3.16104 13.7303C2.86377 13.1781 2.86377 12.4567 2.86377 11.0147V7.66625Z" stroke="#9CA1A6" stroke-width="1.02273" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                            ...
                            <div className={styles.containerHours}>
                                ...
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3.375 9H14.625M14.625 9L10.4062 4.5M14.625 9L10.4062 13.5" stroke="#C0C0C0" stroke-width="1.125" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
