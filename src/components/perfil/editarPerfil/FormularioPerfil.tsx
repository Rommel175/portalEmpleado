        ...
        <>
            ...
            <form className={styles.wraper} onSubmit={handleSubmit}>
                    ...
                    <div className={styles.form}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            }
                            {
                                ...
                                <>
                                    <div className={styles.formItem}>
                                        <h3>Horas semanales</h3>
                                        <input type="text" value={(horasSemana !== null && horasSemana !== 'null') ? String(horasSemana) : ""} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setHorasSemana(e.target.value)} disabled />
                                    </div>
                                    <div className={styles.formItem}>
                                        <h3>Costo/hora</h3>
                                        <input type="text" value={coste ?? ''} onChange={handleChangeCoste} disabled />
                                    </div>
                                </>
                        ...
                        <div className={styles.formGroup2}>
                            ...
                            }
                            {
                                ...
                                <div className={styles.formItem}>
                                    <h3>Dias de vacaciones anuales</h3>
                                    <input type="text" value={diasVacaciones} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setDiasVacaciones(e.target.value)} disabled />
                                </div>
                            }
                ...
                <div className={styles.buttons}>
                    <input type="button" onClick={resetForm} value="Restablecer" />
